...
\begin{center}
\includegraphics[width=1.3\textwidth]{/home/tag/metropolis/Teaching/causal-prediction-workshop/lecturenotes/steno-t1-riskengine.png}
\end{center} 
\end{frame}
